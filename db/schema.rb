...
ActiveRecord::Schema.define(version: 2021_06_05_114748) do
  ...
  create_table "addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_log_id"], name: "index_addresses_on_purchase_log_id"
  end
  ...
  add_foreign_key "addresses", "purchase_logs"
